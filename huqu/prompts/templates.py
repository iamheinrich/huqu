...
class PromptTemplates:
    ...
    def refine_criteria(sample: str, criteria: str, test_results: str) -> str:
        ...
        return (
            ...
            f"Attribute Redundancy: If there are redundant attributes in the criteria that are already covered "
            f"by test_results, please identify and replace them with a single, unified keyword that represents "
            f"all the redundant attributes.\n\n"
            f"Answer format: {{\"redundant\": [\"unified keyword\"]}}\n"
